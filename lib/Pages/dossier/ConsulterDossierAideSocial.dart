...
class ConsulterDossierAideSocial extends StatefulWidget {
  const ConsulterDossierAideSocial({Key? key}) : super(key: key);

  @override
  State<ConsulterDossierAideSocial> createState() =>
      _ConsulterDossierAideSocialState();
}

final user = FirebaseAuth.instance.currentUser!;

class _ConsulterDossierAideSocialState
    extends State<ConsulterDossierAideSocial> {
  @override
          ...
          body: Column(children: [
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: AssetImage('img/undraw_collab_8oes.png'),
                fit: BoxFit.cover,
  ...
  Future<Etat?> readEtat() async {
    ...
    print("++++" + MyApp.cin);
    final doc = db.collection('EtatAideSocial').doc(MyApp.cin);
