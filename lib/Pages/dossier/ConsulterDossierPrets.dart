...
class ConsulterDossierPrets extends StatefulWidget {
  const ConsulterDossierPrets({Key? key}) : super(key: key);

  @override
  State<ConsulterDossierPrets> createState() => _ConsulterDossierPretsState();
}

final user = FirebaseAuth.instance.currentUser!;

class _ConsulterDossierPretsState extends State<ConsulterDossierPrets> {
  @override
          ...
          body: Column(children: [
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: AssetImage('img/undraw_Helpful_sign_re_8ms5.png'),
                fit: BoxFit.cover,
  ...
  Future<Etat?> readEtat() async {
    ...
    print("++++" + MyApp.cin);
    final doc = db.collection('EtatPrets').doc(MyApp.cin);
