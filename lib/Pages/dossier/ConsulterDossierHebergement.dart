...
import '../dossier/déposerDossier.dart';
import '../login/Profile.dart';
import '../../helper/Globals.dart';
import '../login/login_page.dart';

class ConsulterDossierHebergement extends StatefulWidget {
  const ConsulterDossierHebergement({Key? key}) : super(key: key);

  @override
  State<ConsulterDossierHebergement> createState() =>
      _ConsulterDossierHebergementState();
  //static String userCINH = "";
}

final user = FirebaseAuth.instance.currentUser!;

class _ConsulterDossierHebergementState
    extends State<ConsulterDossierHebergement> {
  @override
          ...
          body: Column(children: [
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: AssetImage('img/undraw_apartment_rent_o0ut (1).png'),
                fit: BoxFit.cover,
  ...
  Future<Etat?> readEtat() async {
    ...
    print("(((((++++)))))" + MyApp.cin);
    final doc = db.collection('EtatHebergement').doc(MyApp.cin);
