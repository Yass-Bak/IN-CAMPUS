...
class DemandeExtractionCertiffNonBenif extends StatefulWidget {
  const DemandeExtractionCertiffNonBenif({Key? key}) : super(key: key);

  @override
  State<DemandeExtractionCertiffNonBenif> createState() =>
      _DemandeExtractionCertiffNonBenifState();
}
...
class _DemandeExtractionCertiffNonBenifState
    extends State<DemandeExtractionCertiffNonBenif> {
  final _key29 = GlobalKey<FormState>();
  @override
                  ...
                  child: Column(children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (_key29.currentState!.validate()) {
                            /*       final pdfFile =
                                    await PdfApi.generateCenteredText(
                                        _numerotlfTextController.text.trim());*/
                            final pdfFile;

                            pdfFile = await PdfExtractionNon.generate(
