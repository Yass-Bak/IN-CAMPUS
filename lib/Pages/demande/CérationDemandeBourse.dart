...
class CerationDemandeBourse extends StatefulWidget {
  const CerationDemandeBourse({Key? key}) : super(key: key);

  @override
  static String CINDemB = '';

  State<CerationDemandeBourse> createState() => _CerationDemandeBourseState();
}
...
class _CerationDemandeBourseState extends State<CerationDemandeBourse> {
                      ...
                      child: Column(children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              if (_key5.currentState!.validate()) {
                                /*       final pdfFile =
                ...
                child: Padding(
                  ...
                  child: Column(children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: Validators.compose([
                        Validators.required(
                            ' Le numéro du passeport est requis'),
  ...
  Future uploadDemande(File file) async {
    ...
    final destination = 'Les Demandes/Demandes Bourse/$fileName';
