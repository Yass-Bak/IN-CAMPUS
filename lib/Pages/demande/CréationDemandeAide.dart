...
class CerationDemandeAide extends StatefulWidget {
  const CerationDemandeAide({Key? key}) : super(key: key);

  @override
  static String CINDemA = "";
  State<CerationDemandeAide> createState() => _CerationDemandeAideState();
}
...
class _CerationDemandeAideState extends State<CerationDemandeAide> {
  final _key7 = GlobalKey<FormState>();
  final _key8 = GlobalKey<FormState>();
  @override
                      ...
                      child: Column(children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              if (_key7.currentState!.validate()) {
                                /*       final pdfFile =
                ...
                child: Padding(
                  ...
                  child: Column(children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (_key8.currentState!.validate()) {
                            /*       final pdfFile =
                                      await PdfApi.generateCenteredText(
                                          _numerotlfTextController.text.trim());*/
                            final pdfFile;
  ...
  Future uploadDemande(File file) async {
    ...
    final fileName = (MyApp.cin.trim() +
        file.path
            .substring(file.path.indexOf('app_flutter/'))
            .replaceAll('app_flutter', ""));
    final destination = 'Les Demandes/Demandes Aide Social/$fileName';
