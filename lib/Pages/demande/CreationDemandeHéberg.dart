...
class CerationDemandeHeberg extends StatefulWidget {
  const CerationDemandeHeberg({Key? key}) : super(key: key);

  @override
  static String CINDemH = "";
  State<CerationDemandeHeberg> createState() => _CerationDemandeHebergState();
}
...
class _CerationDemandeHebergState extends State<CerationDemandeHeberg> {
  final _key9 = GlobalKey<FormState>();
  final _key10 = GlobalKey<FormState>();
  @override
                      ...
                      child: Column(children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              if (_key9.currentState!.validate()) {
                                /*       final pdfFile =
                ...
                child: Padding(
                  ...
                  child: Column(children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (_key10.currentState!.validate()) {
                            /*       final pdfFile =
                                      await PdfApi.generateCenteredText(
                                          _numerotlfTextController.text.trim());*/
                            final pdfFile;
  ...
  Future uploadDemande(File file) async {
    ...
    final destination = 'Les Demandes/Demandes Hébergements/$fileName';
