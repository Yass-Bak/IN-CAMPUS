    ...
    pdf.addPage(
      MultiPage(
        build: (context) => <Widget>[
          ...
          Paragraph(text: "Numéro Passport :" + NumPass),
          Paragraph(text: "Nationalité:" + Natio),
          Paragraph(text: "Nom et Prénom :" + NomEtudiant),
          Paragraph(text: "Identifiant :" + Cin),
          Paragraph(text: "Date de naissance :" + DateNais),
          Paragraph(text: "Lieu de naissance:" + LieuNais),
          Paragraph(text: "Adresse en Tunisie:" + Adresse),
